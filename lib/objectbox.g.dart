  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    Podcast: obx_int.EntityDefinition<Podcast>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final podcastNameParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 8, '');
        final authorsParam = obx.ToMany<Author>();
        final schedulesParam = obx.ToMany<Schedule>();
        final onlyMusicParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          10,
          false,
        ...
        final hasEpisodesParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          14,
          false,
        ...
        final isFavoritedParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          18,
          false,
        ...
        obx_int.InternalToManyAccess.setRelInfo<Podcast>(
          object.authors,
          store,
          obx_int.RelInfo<Podcast>.toMany(5, object.id),
        );
        obx_int.InternalToManyAccess.setRelInfo<Podcast>(
          object.schedules,
          store,
          obx_int.RelInfo<Podcast>.toMany(6, object.id),
        );
        return object;
      },
    ),
    Schedule: obx_int.EntityDefinition<Schedule>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final startParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 8, '');
        final endParam = const fb.StringReader(
          asciiOptimization: true,
    ...
    Episode: obx_int.EntityDefinition<Episode>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final podcastIdParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          8,
        );
        ...
        final episodeDurationParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          16,
          0,
        );
        final hasPodcastParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          18,
          false,
...
class Author_ {
  ...
  /// See [Author.isGuest].
  static final isGuest = obx.QueryBooleanProperty<Author>(
...
class Podcast_ {
  /// See [Podcast.id].
  static final id = obx.QueryIntegerProperty<Podcast>(
    _entities[1].properties[0],
  );

  /// See [Podcast.podcastId].
  static final podcastId = obx.QueryIntegerProperty<Podcast>(
    _entities[1].properties[1],
  );

  /// See [Podcast.podcastName].
  static final podcastName = obx.QueryStringProperty<Podcast>(
    _entities[1].properties[2],
  );

  /// See [Podcast.onlyMusic].
  static final onlyMusic = obx.QueryBooleanProperty<Podcast>(
    _entities[1].properties[3],
  );

  /// See [Podcast.isActive].
  static final isActive = obx.QueryBooleanProperty<Podcast>(
    _entities[1].properties[4],
  );

  /// See [Podcast.hasEpisodes].
  static final hasEpisodes = obx.QueryBooleanProperty<Podcast>(
    _entities[1].properties[5],
  );

  /// See [Podcast.isFavorited].
  static final isFavorited = obx.QueryBooleanProperty<Podcast>(
    _entities[1].properties[6],
  );

  /// See [Podcast.image].
  static final image = obx.QueryStringProperty<Podcast>(
    _entities[1].properties[7],
  );

  /// see [Podcast.authors]
  static final authors = obx.QueryRelationToMany<Podcast, Author>(
    _entities[1].relations[0],
  );

  /// see [Podcast.schedules]
  static final schedules = obx.QueryRelationToMany<Podcast, Schedule>(
...
class Schedule_ {
  ...
  static final weekday = obx.QueryIntegerProperty<Schedule>(
    _entities[2].properties[1],
  );

  /// See [Schedule.start].
  static final start = obx.QueryStringProperty<Schedule>(
    _entities[2].properties[2],
  );

  /// See [Schedule.end].
  static final end = obx.QueryStringProperty<Schedule>(
...
class Episode_ {
  /// See [Episode.id].
  static final id = obx.QueryIntegerProperty<Episode>(
    _entities[3].properties[0],
  );

  /// See [Episode.episodeId].
  static final episodeId = obx.QueryIntegerProperty<Episode>(
    _entities[3].properties[1],
  );

  /// See [Episode.podcastId].
  static final podcastId = obx.QueryIntegerProperty<Episode>(
    _entities[3].properties[2],
  );

  /// See [Episode.date].
  static final date = obx.QueryDateNanoProperty<Episode>(
    _entities[3].properties[3],
  );

  /// See [Episode.name].
  static final name = obx.QueryStringProperty<Episode>(
    _entities[3].properties[4],
  );

  /// See [Episode.imgPath].
  static final imgPath = obx.QueryStringProperty<Episode>(
    _entities[3].properties[5],
  );

  /// See [Episode.episodeDuration].
  static final episodeDuration = obx.QueryDoubleProperty<Episode>(
    _entities[3].properties[6],
  );

  /// See [Episode.hasPodcast].
  static final hasPodcast = obx.QueryBooleanProperty<Episode>(
    _entities[3].properties[7],
  );

  /// See [Episode.isFavorited].
  static final isFavorited = obx.QueryBooleanProperty<Episode>(
    _entities[3].properties[8],
  );

  /// See [Episode.updatedAt].
  static final updatedAt = obx.QueryDateNanoProperty<Episode>(
    _entities[3].properties[9],
  );

  /// See [Episode.progress].
  static final progress = obx.QueryIntegerProperty<Episode>(
